...
public class Worker {
    ...
    public String wordDiff(List<Device> taps, Device pump, Device fertilizerApplicator,
        ...
        // 第二阶段
//        JSONObject secondStage = new JSONObject(true);
//        schedulingSeqArray.add(secondStage);
//        secondStage.set("irrigation_Stage", 2);
//        secondStage.set("irrigation_Type", 0);
//        // 用水量
//        Double t2Water = (waterNum - sumSize * headWaterConsumption - sumSize * tailWaterConsumption - (waterAndFertilizer * (fertilizerK + fertilizerN + fertilizerP)));
//        secondStage.set("irrigation_Water", t2Water);
